...
import { Mail, MapPin, Send, Instagram, Youtube, Facebook, CheckCircle2, MessageSquare, Share2 } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div className="space-y-12">
            ...
            <div className="pt-10 border-t border-outline-variant/20">
              <h5 className="font-mono text-xs text-secondary uppercase tracking-widest font-bold mb-6">
                Canais Sociais
              </h5>
              <p className="font-sans text-xs text-on-surface-variant font-light mb-4">
                Acompanhe nosso conteúdo estratégico e novidades nas redes sociais.
              </p>
              <div className="flex flex-wrap gap-3">
                {/* Instagram */}
                <a
                  href="https://instagram.com"
                  className="w-10 h-10 border border-outline-variant/30 rounded hover:border-secondary hover:text-secondary flex items-center justify-center text-on-surface-variant transition-all cursor-pointer"
