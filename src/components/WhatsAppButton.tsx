...
export default function WhatsAppButton({ message = DEFAULT_MESSAGE }: { message?: string }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-8 right-8 z-[9999] w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-300 cursor-pointer animate-pulse-whatsapp"
    >
